...
const Path = styled.path`
  fill: ${props => (props.white ? colors.white : colors.main)};
`
export default function Transformation(props) {
  return (
    <Svg x='0px' y='0px' viewBox='0 0 447.907 447.907'>
      <Path
        white={props.white}
        d='M432.703,206.904l-30.5-13.2l-25.9-50.4c-7-13.8-21.2-22.4-36.7-22.3h-44.6v-12.6c0-22.8-18.2-41.4-41-41.4h-213.2
